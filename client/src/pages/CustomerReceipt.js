...
const CustomerReceipt = () => {
  ...
  const sendWhatsApp = async () => {
    ...
    const message = `سلاف بەرێز ${customer.name}، سوپاس هەلبژارتناتە بو نڤێسینگەها ئەحمەد ئەلکتریک`;
      ...
      <div id="pdf-content">
        <Box mb={3}>
          ...
          <Typography variant="h5" fontWeight="bold" mt={1} sx={{ fontSize: '21px', textAlign: 'center', marginTop: '-20px' }}>
            ...
            <p style={{ fontSize: '20px' }}>هەر وەسا ئەم دئامادەینە بوو دروستکرنا هەمی جوری ئاڤاهیا ب دیزاینێت سەردەمانە و مودرن</p>
          </Typography>
        </Box>
